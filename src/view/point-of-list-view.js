...
function createPointOfListTemplate(point,offers,destinations) {
  ...
  return (`<li class="trip-events__item">
    <div class="event">
      <time class="event__date" datetime=${dateFrom}>${getHumanizeTaskDueDate(dateFrom,DATE_FORMAT)}</time>
      ...
      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${dateFrom}">${getHumanizeTaskDueDate(dateFrom,HOURS_FORMAT)}</time>
          &mdash;
          <time class="event__end-time" datetime="${dateTo}">${getHumanizeTaskDueDate(dateTo,HOURS_FORMAT)}</time>
        </p>
  ...
  ${isFavorite ? '<button class="event__favorite-btn event__favorite-btn--active" type="button">' : '<button class="event__favorite-btn" type="button">'}
